...
namespace RoadGeneration
{
    ...
    class MajorGenerator
    {
        ...
        private readonly bool isGridMode;
        ...
        private void GenerateStartSegments()
        {
            ...
            int sampleX = UnityEngine.Random.Range(0, (border * 100));
            int sampleY = UnityEngine.Random.Range(0, (border * 100));
            ...
            int randomDirX = UnityEngine.Random.Range(-100, 100);   // random 
            int randomDirY = UnityEngine.Random.Range(-100, 100);

            if(isGridMode == true || maxLean == 0)
            {
                randomDirX = 100;
                randomDirY = 1;
            }
        ...
        private float GetRandomAngle(int a, int b) //Calculates an Angle between a and b, returns it in radian
        {
            ...
            int rotation = UnityEngine.Random.Range(0, range) + a;
